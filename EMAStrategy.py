...
class EMAStrategy(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["entry_long"] = entry_long_m1 | entry_long_m2
        ...
        dataframe["entry_short"] = entry_short_m1 | entry_short_m2
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float,
        ...
        try:
            ...
            signal = {
                ...
                "balance": float(self.wallets.get_free_stake_amount() + self.wallets.get_total_stake_amount()),
            }
